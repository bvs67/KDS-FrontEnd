...
import { ADD_PAD_REQUEST } from '../actions/StrucActions'
import { ADD_PAD_SUCCESS } from '../actions/StrucActions'
import { ADD_PAD_FAIL } from '../actions/StrucActions'

import { DEL_PAD_REQUEST } from '../actions/StrucActions'
import { DEL_PAD_SUCCESS } from '../actions/StrucActions'
import { DEL_PAD_FAIL } from '../actions/StrucActions'
...
export function strucReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case ADD_PAD_REQUEST:
        return { ...state, isFetching: true };
       
    case ADD_PAD_SUCCESS:
        return { ...state, isFetching: false };
        
    case ADD_PAD_FAIL:
        return { ...state, isFetching: false };
        
    case DEL_PAD_REQUEST:
        return { ...state, isFetching: true };
       
    case DEL_PAD_SUCCESS:
        return { ...state, isFetching: false };
