...
import { SAVE_KIT_REQUEST } from '../actions/CompActions'
import { SAVE_KIT_SUCCESS } from '../actions/CompActions'
import { SAVE_KIT_FAIL } from '../actions/CompActions'

import { NEW_KIT_REQUEST } from '../actions/CompActions'
import { NEW_KIT_SUCCESS } from '../actions/CompActions'
import { NEW_KIT_FAIL } from '../actions/CompActions'
...
export function umbkitReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case SAVE_KIT_REQUEST:
      return { ...state, isFetching: true };
  
    case SAVE_KIT_SUCCESS:
      return { ...state, isFetching: false };
    
    case SAVE_KIT_FAIL:
      return { ...state, isFetching: false };
  
    case NEW_KIT_REQUEST:
      return { ...state, isFetching: true };
    
    case NEW_KIT_SUCCESS:
      return { ...state, isFetching: false };
