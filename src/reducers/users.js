...
import { TRANS_PAD_REQUEST } from '../actions/UsersActions'
import { TRANS_PAD_SUCCESS } from '../actions/UsersActions'
import { TRANS_PAD_FAIL } from '../actions/UsersActions'

import { EDIT_USER_REQUEST } from '../actions/UsersActions'
import { EDIT_USER_SUCCESS } from '../actions/UsersActions'
import { EDIT_USER_FAIL } from '../actions/UsersActions'

import { ADD_USER_REQUEST } from '../actions/UsersActions'
import { ADD_USER_SUCCESS } from '../actions/UsersActions'
import { ADD_USER_FAIL } from '../actions/UsersActions'
...
export function usersReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case TRANS_PAD_REQUEST:
        return { ...state, isFetching: true };
       
    case TRANS_PAD_SUCCESS:
        return { ...state, isFetching: false };
