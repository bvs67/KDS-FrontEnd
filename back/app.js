...
var addPadRouter = require('./routes/addPad');
var transPadRouter = require('./routes/transPad');
var delPadRouter = require('./routes/delPad');
var saveKitRouter = require('./routes/savekit');
var newKitRouter = require('./routes/newkit');
...
app.use('/addPad', addPadRouter);
app.use('/transPad', transPadRouter);
app.use('/delPad', delPadRouter);
app.use('/savekit', saveKitRouter);
app.use('/newkit', newKitRouter);
